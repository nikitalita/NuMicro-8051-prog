# # Flash_type bits:
# Bits [1:0] indicate the presence of data flash
# Bit [2] likely indicates that this chip has slow flash (only the N76E616 has it set, and it is the only one that has special programming timing)
# SPROM presence is either indicated by bits [6:4] or bit [24], 
# but I am unsure because I can't actually confirm whether or not the N76S003 has SPROM
# the datasheet is ambiguous and it looks like they've just copied and pasted most of the datasheet 
# from the MG51 series, to which it technically belongs
